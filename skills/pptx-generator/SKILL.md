...
- `PptxEditor.Core/Generation/Design/*.tokens.json` — pre-mined design token sets (mined from pres-pro / AetherLink; source decks removed pre-public-release for licensing, token sets retained as design facts)
