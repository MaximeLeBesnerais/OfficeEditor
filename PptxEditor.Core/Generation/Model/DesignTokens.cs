...
/// <summary>
/// Design tokens (plan.md §3.1): the palette, fonts, shape defaults and metrics every
...
public sealed record DesignTokens
{
    ...
    /// <summary>Metric defaults in points. Optional; defaults from plan.md §3.1.</summary>
...
public sealed record ShapeTokens
{
    ...
    /// <summary>Default card treatment (plan.md §8 Q2: three styles are enough for v1).</summary>
    public CardStyle CardStyle { get; init; } = CardStyle.Flat;
}

/// <summary>Metric defaults in points; all values are pt — never percentages (plan.md §1).</summary>
...
/// <summary>Card surface treatment (plan.md §3.1 shape.cardStyle).</summary>
