...
After any change to the compile path, run a smoke test on `examples/REF/PPTX/Presentation1.pptx` and `pres-pro.pptx`. Diff generated PDFs against the reference PDFs in `examples/REF/PPTX/`.
