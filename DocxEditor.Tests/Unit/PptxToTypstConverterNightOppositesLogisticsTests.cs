...
/// <summary>Regression contracts for the Opposites and Logistics freeform sweep.</summary>
public sealed class PptxToTypstConverterNightOppositesLogisticsTests : IDisposable
{
    private readonly string _tempDir = Path.Combine(
        Path.GetTempPath(), nameof(PptxToTypstConverterNightOppositesLogisticsTests), Guid.NewGuid().ToString("N"));

    public PptxToTypstConverterNightOppositesLogisticsTests() => Directory.CreateDirectory(_tempDir);
