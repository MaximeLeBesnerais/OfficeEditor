...
/// <summary>
/// Regression tests for defects found on the Pencil decks (showeet templates):
...
/// </summary>
public sealed class PptxToTypstConverterPencilWideTests : IDisposable
{
    ...
    public PptxToTypstConverterPencilWideTests()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), nameof(PptxToTypstConverterPencilWideTests), Guid.NewGuid().ToString("N"));
    ...
    /// templates lean on this heavily (e.g. horizontal pencil glyphs stood
    ...
    /// cannot force a wrap (Pencil-Wide cover taglines "19 Unique PPTX
                ...
                new P.TextBody(
                    ...
                    new Drawing.Paragraph(
                        new Drawing.Run(
                            ...
                            new Drawing.Text("19 Unique PPTX Slides")))));
    ...
    /// (→ dk1) color — not hardcoded black. The Pencil decks redefine dk1 as
    ...
    /// overrides even an explicit solidFill. Pencil-Wide slide 22's
    /// "www.showeet.com" is white/50% in XML but teal #16A085 + underline in
    /// the official PDF.
    /// </summary>
    [Fact]
