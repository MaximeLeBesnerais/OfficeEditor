...
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    ...
    public void Extract_HomePlate_ReturnsAspectAwarePolygon()
    {
        ...
        // 0.5-width table would be grossly wrong (INV-slide-025).
        var xml = $@"
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    <a:xfrm>
...
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    ...
    {
        // INV-slide-033: a stroke-only connector arc (noFill blockArc) is clipped to
...
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    ...
    {
        // INV-regressions-b1 §1: the cached trapezoid adj (64780 on slides
...
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    ...
    {
        // INV-regressions-b1 §1: slides 134/135 regressed because the bbox
...
<dsp:sp xmlns:dsp=""{DspNs}"" xmlns:a=""{ANs}"">
  <dsp:spPr>
    ...
    {
        // INV-regressions-b1 §4 (slide 152, drawing149): the rotation-blind
    ...
    {
        // INV-slide-130: the rotation-blind bbox inflated the content height
