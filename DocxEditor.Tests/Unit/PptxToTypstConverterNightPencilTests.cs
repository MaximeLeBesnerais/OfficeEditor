...
/// <summary>Small synthetic regressions for the remaining Pencil converter edge cases.</summary>
public sealed class PptxToTypstConverterNightPencilTests : IDisposable
{
    private const string PngBase64 =
        "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==";
    private readonly string _tempDir = SlideOpsTestHelpers.CreateTempDirectory(nameof(PptxToTypstConverterNightPencilTests));
