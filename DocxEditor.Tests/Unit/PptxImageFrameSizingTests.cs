...
public sealed class PptxImageFrameSizingTests
{
    ...
    {
        using var document = PresentationDocument.Open(ReferencePath("REMOVED.pptx"), false);
    ...
    [Fact]
    public void Convert_REMOVEDSlide1BackgroundImage_UsesFullSlideFrame()
    {
        var (presentation, source) = ConvertReference("REMOVED.pptx");
    ...
    [Fact]
    public void Convert_REMOVEDSlide2GroupedImage_UsesTransformedFrame()
    {
        var (presentation, source) = ConvertReference("REMOVED.pptx");
