...
public sealed class PptxImageFrameSizingTests
{
    ...
    {
        using var document = PresentationDocument.Open(ReferencePath("Presentation1.pptx"), false);
    ...
    [Fact]
    public void Convert_Presentation1Slide1BackgroundImage_UsesFullSlideFrame()
    {
        var (presentation, source) = ConvertReference("Presentation1.pptx");
    ...
    [Fact]
    public void Convert_Presentation1Slide2GroupedImage_UsesTransformedFrame()
    {
        var (presentation, source) = ConvertReference("Presentation1.pptx");
