...
#place(top + left, dx: 0.00pt, dy: 113.39pt)[#text(size: 18.00pt)[2. Convert to Typst elements]]
#place(top + left, dx: 0.00pt, dy: 113.39pt)[#text(size: 18.00pt)[3. Generate Typst source]]
#place(top + left, dx: 0.00pt, dy: 113.39pt)[#text(size: 18.00pt)[4. Compile with typstsharp]]
