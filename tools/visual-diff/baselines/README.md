> Note: `baselines/pptx/` (derived from the pres-pro / pitch-deck REF decks) was removed pre-public-release (licensing) and must be regenerated once replacement REF fixtures land.
