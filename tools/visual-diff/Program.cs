...
static List<ComparisonInput> BuildInputs(CliOptions options)
{
    if (options.Suite is not null)
    {
        ...
        [
            ...
            new("gestion-risques-entreprise-bcp-pme", "examples/REF/DOCX/gestion-risques-entreprise-bcp-pme.pdf", "examples/output/ref/docx/gestion-risques-entreprise-bcp-pme.pdf")
        ];
    }
