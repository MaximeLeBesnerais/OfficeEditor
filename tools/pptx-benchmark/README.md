...
Per deck (currently only `examples/REF/PPTX/northwind-demo.pptx`; the former third-party REF decks — pres-pro, AetherLink, FusionFest, pitch-deck — were removed pre-public-release for licensing, replacements pending), in a fresh child process:
