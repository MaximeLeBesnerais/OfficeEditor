    ...
    CancellationToken ct) =>
{
    ...
    // Envelope: { "name": "", "ppi": 110, "format": "svg" } — ppi and format
    ...
    CancellationToken ct) =>
{
    ...
    // Envelope: { "name": "", "ppi": 110 } — parsed defensively like /api/demo/render.
    string? name = null;
    int? requestedPpi = null;
    try
    {
    ...
    CancellationToken ct) =>
{
    ...
    // Envelope: { "name": "", "ppi": 110 } — parsed defensively like the
