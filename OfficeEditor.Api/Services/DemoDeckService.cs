...
public sealed class DemoDeckService : IDemoDeckService
{
    ...
    [
        new(
            ...
            "16-slide professional sales deck (reference render target)"),
        new(
            "aetherlink",
            "examples/REF/PPTX/AetherLink-Glass-Shareholder-Overview.pptx",
            "AetherLink glass-style shareholder overview"),
        new(
            "fusionfest",
            "examples/REF/PPTX/FusionFest-Architecture-Overview.pptx",
            "FusionFest architecture overview"),
        new(
            "pitch-deck",
            "examples/REF/PPTX/pitch-deck.pptx",
            "Investor pitch deck")
    ];
